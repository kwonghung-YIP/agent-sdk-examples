...
async def main() -> None:
    options = ClaudeAgentOptions(
        ...
        # tool permissions of subagent is bounded by the parent agent
        allowed_tools=[
            "Agent",
            "WebSearch",
            "WebFetch",
    ...
    msgLogPath = Path("messages/market-research-subagent")
    ...
    async for message in query(
        ...
        i = i + 1
        with open(msgLogPath / f"market-research_{i}_{type(message).__name__}.json", mode="w") as f:
